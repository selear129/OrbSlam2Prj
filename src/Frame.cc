...
/*
    ...
    if () is used behind object, this means () is a operator
    such as:
        Class *obj;
        ((*obj)(para1,para2,...)); //call operator()

    if () is used behind class name(classname(para1,para2,...)), means create a new object
    such as
        obj = Class(para1,para2,...);

    operator example:
        http://blog.csdn.net/neonlight/article/details/6065196

    Frame::ExtractORB() calc ORB discriptor and image pyramid
*/
